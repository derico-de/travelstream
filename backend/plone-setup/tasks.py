...
def create_site(c, site_id="Plone", instance="instance"):
    ...
    project_title = 'Plone Setup'
    project_description = 'A Plone project'
    script = '''\
...
transaction.commit()
print("Created site:", %r)
''' % (site_id, project_title, project_description, site_id)
